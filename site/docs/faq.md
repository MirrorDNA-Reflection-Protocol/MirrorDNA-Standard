...
Common questions about MirrorDNA, compliance, vaults, and more.
...
- **Don't hallucinate** - Cite-or-silence protocol ensures claims are sourced
- **Preserve continuity** - State persists across sessions
- **Give users sovereignty** - Vault-backed storage with user control

**This repository** (MirrorDNA-Standard) is the canonical specification and validation toolchain.

---

### Is MirrorDNA a product or a protocol?

**Protocol**. This repository defines the standard. Products like **ActiveMirrorOS™** implement the standard.
...
**Detailed guide:** See [Compliance Levels](compliance-levels.md)
...
See [Validator Guide](validators.md) for detailed usage.
...
See [Validators - CI/CD Integration](validators.md#cicd-integration) for setup.
...
Recommendation: Add 'lineage_tracking: true' to continuity_profile.yaml
```
...
**Yes**. Copy [`00_MASTER_CITATION.md`](https://github.com/MirrorDNA-Reflection-Protocol/MirrorDNA-Standard/blob/main/00_MASTER_CITATION.md) into the AI and say:

> "Vault open. Load as canonical context."

This gives you reflective behavior without needing to install anything.

**Pastebin mirror:** [https://pastebin.com/j0MdNxrA](https://pastebin.com/j0MdNxrA)
...
See [Architecture - Portable](architecture.md#portable-reference-implementation) for details.
...
1. Pass validation
2. Copy badge markdown from [`badges/README.md`](https://github.com/MirrorDNA-Reflection-Protocol/MirrorDNA-Standard/tree/main/badges/README.md)
...
**GitHub Issues:** [https://github.com/MirrorDNA-Reflection-Protocol/MirrorDNA-Standard/issues](https://github.com/MirrorDNA-Reflection-Protocol/MirrorDNA-Standard/issues)
...
3. Validate YAML syntax: [https://www.yamllint.com/](https://www.yamllint.com/)
...
- **Spec questions:** Read [MirrorDNA Standard](mirrordna-standard.md)
- **Validator help:** `python -m validators.cli --help`
- **Examples:** [Examples Guide](examples.md)
- **Terms:** [Glossary](glossary.md)
- **FAQ:** You're here!
- **Bugs:** [GitHub Issues](https://github.com/MirrorDNA-Reflection-Protocol/MirrorDNA-Standard/issues)

---

!!! quote "Still Have Questions?"
    Open an issue on GitHub or check the [full documentation](index.md).
